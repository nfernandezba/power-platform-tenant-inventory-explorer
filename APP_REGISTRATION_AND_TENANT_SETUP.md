...
2. You have permission to create an App Registration. In many tenants, standard users can register applications by default. If your organisation has disabled that capability, an administrator can assign the **Application Developer** role or another suitable application-administration role.
...
Microsoft notes that the Power Platform API service principal might not yet exist in some tenants. An Entra administrator may need to provision or refresh the resource service principal according to Microsoft's Power Platform authentication guidance.
...
2. Tienes permisos para crear una App Registration. En muchos tenants, los usuarios estándar pueden registrar aplicaciones de forma predeterminada. Si tu organización ha deshabilitado esa capacidad, un administrador puede asignarte el rol **Application Developer** u otro rol apropiado de administración de aplicaciones.
...
Microsoft indica que en algunos tenants el Service Principal de Power Platform API puede no estar creado. Un administrador de Entra puede necesitar aprovisionar o actualizar el recurso siguiendo la guía oficial de autenticación de Power Platform.
