...
The summary groups resources by:

- Resource type.
- Region.
- Environment ID.

This query supplies the Overview KPIs and expected counts without retrieving every detailed record.
...
| Control | Default |
|---|---:|
| Inventory page size | 1,000 records |
